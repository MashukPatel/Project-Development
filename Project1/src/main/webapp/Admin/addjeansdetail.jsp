										...
										<div class="card-block">
											...
											<form method="post" action="../AdminController"
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="Material Type" name="materialtype">
													</div>
												</div>
												...
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">Closure Type</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="Closure Type" name="closuretype">
													</div>
												</div>
												
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">Occasion Type</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="Occasion Type" name="occasiontype">
													</div>
												</div>
												
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">Care Instruction</label>
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="Care Instruction" name="careinstruction">
													</div>
												</div>
